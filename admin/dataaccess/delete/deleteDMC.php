<?php 
    ...
    if (isset($_POST['submit'])){
        $delete = $data->remove('category_detail',"`id`='$id'");
        if(isset($delete)){
...
<?php include_once '../general/header.php';?>
            <form id="form-update" action="" name="themdml" method="post">
                     <span class="title-table">Xóa Danh Mục Con</span>
                     ...
                     <div class="pnlUpdateAction">
                        <input type="submit" name="submit" value="Lưu" > | 
                         <a href="../../danhmuccon.php"><input type="submit" name="submit1" value="Trở Về"></a> 
                     ...
                     <table class="update-table" cellspacing="0" cellpadding="0"><tbody>
                           ...
                           <td class="update-td" style="width:150px;">
                              ...
                              <td class="update-td">
                                  ...
                                  <?php 
                                         $danhmuc = $data->get_list("SELECT * FROM `category`");
                                        
                                             foreach ($danhmuc as $arrDML){
