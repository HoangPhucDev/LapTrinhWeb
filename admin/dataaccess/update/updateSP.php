...
//tiến hành update dữ liệu
                     ...
                     if(is_numeric($SoLuong) && is_numeric($GiaBan) && $TenSP!=''){
                       @$update = $data->update('products',$San_Pham,"`id`='$id'");
                        if (isset($update)){
...
?>
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <input type="text" name="TenSP" value="<?php echo $ListSP['name'];?>" class = "form-control" placeholder="Tên Sản Phẩm">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <input type="number" name="GiaBan" value="<?php echo $ListSP['price'];?>" class="form-control">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <input type="number" name="GiamGiam" value="<?php echo $ListSP['saleoff'];?>" class="form-control">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <input type="number" name="SoLuong" value="<?php echo $ListSP['avaibility'];?>" class="form-control" min="1">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <input type="text" name="Size" value="<?php echo $ListSP['size'];?>" class="form-control" placeholder="Các Size Của Sản Phẩm">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <input type="text" value="<?php echo $ListSP['color'];?>" class="form-control" placeholder="Màu Sản Phẩm">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
            <textarea name="ChiTiet" class="form-control" rows="10" cols="30" placeholder="Chi Tiết Sản Phẩm"><?php echo $ListSP['description'];?></textarea>
            </div>
        </div>
<p>
            <div class="form-group">
                <div class="col-md-offset-2 col-md-10">
                    <input type="submit" value="Sửa" class="btn btn-success" name="ok" />
